...
- **Hip Rafter Overhang (Tails)**: Gorgeous 12-inch overhang tails extending past the posts and sloping along the roof pitch.
- **Jack Rafters (Common Rafters)**: 12 jack rafters (2 per side) mathematically solved to intersect flush with the sides of the hip rafters.
- **Purlin Ring**: A solid hexagonal collar/purlin ring connecting the 6 hip rafters at a 55% roof height.
